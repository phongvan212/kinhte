...
<!--#endif-->
  ...
  <body tabindex="1">
    <div id="outerContainer" class="loadingInProgress">
      <input id="pdfHeight" hidden="hidden" value="" />
        ...
        <div id="secondaryToolbar" class="secondaryToolbar hidden doorHangerRight">
          <div id="secondaryToolbarButtonContainer">
            ...
            <button id="pageRotateCw" class="secondaryToolbarButton rotateCw" title="Rotate Clockwise" tabindex="25" data-l10n-id="page_rotate_cw">
              <span class="btnRotate" data-l10n-id="page_rotate_cw_label">Rotate Clockwise</span>
            </button>
            <button id="pageRotateCcw" class="secondaryToolbarButton rotateCcw" title="Rotate Counterclockwise" tabindex="26" data-l10n-id="page_rotate_ccw">
              <span class="btnRotate" data-l10n-id="page_rotate_ccw_label">Rotate Counterclockwise</span>
            </button>
          </div>
...
<script>
    $(document).ready(function () {
        var resInterval = setInterval(function () {
            if ($('.page').length > 0 && $('.page').length==$('canvas').length) {
                clearInterval(resInterval);
                hgtChange();
            }
        }, 50);
        $("#scaleSelect").change(function () {
            var scaleIntv = setInterval(function () {
                    hgtChange();
            }, 50);
        });
        $("#zoomIn").click(function () {
            var zoomInIntv = setInterval(function () {
                    hgtChange();
            }, 50);
        });
        $("#zoomOut").click(function () {
            var zoomOutIntv = setInterval(function () {
                hgtChange();
            }, 50);
        });
    ...
    function hgtChange() {
        ...
        var lgt = $('.page').length;
        for (var i = 1; i <= lgt; i++) {
            var name = "#pageContainer" + i;
            height += $(name).height()+12;
        }
        $("#pdfHeight").val(height);
    }
</script>